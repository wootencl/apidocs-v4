...
| monitoring.{api_name}.last_updated     | {datetime}| The date the monitoring status was last updated. Field returned only for /tradingpartners/{id} request. In ISO8601 format (YYYY-MM-DDThh:mm:ssTZD).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
