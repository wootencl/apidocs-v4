...
| diagnosis_mappings.destination_scenarios.choice_lists.description  | the description of the diagnosis mapping code                                                                                                                       |
| diagnosis_mappings.destination_scenarios.choice_lists.value        | the value associated with the diagnosis mapping code                                                                                                                |
| diagnosis_mappings.destination_scenarios.choice_lists.system       | the system associated with with the diagnosis mapping code (e.g. icd9, icd10)                                                                                       |
